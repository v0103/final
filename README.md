...
2.Delete:Delete a given item from the database.
    ...
    input 2, then input a player's name, and then choose a team for the player

3.Compare: compare two players data.

    input 3, then input first player's name, then input second player's name
    then input the correct team for player1,player2

4.Search:Given certain information about the item, the program needs to find and print the specific item.
...
6.Sort(descned):sort data in descend form basd on chosen item type
